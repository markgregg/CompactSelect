...
const CompactSelectDisplay = <T extends object | string>(
  ...
  const displayTitle = props.selected.length === 0 && (!props.choicesShown || (!props.selectType || props.selectType !== 'standard'));
  ...
  return (
    <p
      className={scssClasses.csTextDisplay + textDisplayClassName()}
