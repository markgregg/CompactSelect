...
export const FontSizeProperty = (
  name: string,
  value: CSS.Property.FontSize | undefined,
  setValue: (value?: CSS.Property.FontSize) => void
) => (
...
export const FontFamilyProperty = (
  name: string,
  value: CSS.Property.FontFamily | undefined,
  setValue: (value?: CSS.Property.FontFamily) => void
) => (
  <div className="example">
    <p>{name}</p>
    <CompactSelect
...
export const FontWeightProperty = (
  name: string,
  value: CSS.Property.FontWeight | undefined,
  setValue: (value?: CSS.Property.FontWeight) => void
) => (
  <div className="example">
    <p>{name}</p>
    <CompactSelect
...
export const FontStyleProperty = (
  name: string,
  value: CSS.Property.FontStyle | undefined,
  setValue: (value?: CSS.Property.FontStyle) => void
) => (
  <div className="example">
    <p>{name}</p>
    <CompactSelect
...
export const BorderStyleProperty = (
  name: string,
  value: CSS.Property.BorderStyle | undefined,
  setValue: (value?: CSS.Property.BorderStyle) => void
) => (
  <div className="example">
    <p>{name}</p>
    <CompactSelect
...
export const ColorProperty = (
  name: string,
  value: CSS.Property.Color | undefined,
  setValue: (value?: CSS.Property.Color) => void
) => {
